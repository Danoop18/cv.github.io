...
image:
  ...
  Focal_point: Smart
  Preview_only: false
  All_text: "Imagen representativa del formato con macros usado en el registro manual de carga por pacientes semanal"
categories:
  - Engineering
...
![alt text](/uploads/Macros_formato.png)
...
1. Los registros brutos de múltiples archivos se descargan en un único contexto de procesamiento (hoja de cálculo o script, según la etapa).
...
3. Se realiza la relación entre codigo de estudio y el nombre comun usado en los reportes para homogenizar los registros.
4. Los datos limpios y validados se escriben en una salida única estructurada para reporte operativo.
