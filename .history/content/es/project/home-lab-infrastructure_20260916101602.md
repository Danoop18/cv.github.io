...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;">
  <img src="/uploads/Homelab_2.png" alt=" 1" style="width: 100%; border-radius: 15px;">
  <img src="/uploads/Homelab_1.png" alt=" 2" style="width: 100%; border-radius: 15px;">
  <img src="/uploads/Homelab_3.png" alt=" 3" style="width: 100%; border-radius: 15px;">
</div>   
<!-- <table>
  <tr>
